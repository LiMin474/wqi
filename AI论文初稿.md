...
![图2: Jajpur数据集集成增益](python_code/datasets/results/figures/fig2_jajpur_ensemble.png)

**图2. Jajpur数据集单算法与集成R²CV对比**
...
![图3: Jajpur数据集算法分歧度热图](python_code/datasets/results/figures/fig3_jajpur_correlation.png)

**图3. Jajpur数据集基模型预测值间Pearson相关系数热图**
...
![图4: AKH数据集算法分歧度热图](python_code/datasets/results/figures/fig4_akh_correlation.png)

**图4. AKH数据集基模型预测值间Pearson相关系数热图**

![图5: 四个数据集特征相关性热图](python_code/datasets/results/figures/fig5_feature_correlation.png)
...
![图6: Jajpur数据集MAE对比箱线图](python_code/datasets/results/figures/fig6_jajpur_mae.png)

**图6. Jajpur数据集集成与基模型MAE对比箱线图**
...
![图7: AKH数据集MAE对比箱线图](python_code/datasets/results/figures/fig7_akh_mae.png)

**图7. AKH数据集集成与基模型MAE对比箱线图**
