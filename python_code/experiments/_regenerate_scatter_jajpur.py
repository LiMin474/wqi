"""
Regenerate scatter CSV with all samples
Run the full experiment for specified dataset, then save scatter CSV.
"""
import warnings
...
print('=' * 60)
print(f'Regenerating scatter_{model_name}_{dataset_name}.csv')
print('=' * 60)
...
print(f'\n[OK] {path} saved with {len(y)} samples')
