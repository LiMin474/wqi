"""
仅运行AKH-WQI数据集（6进化算法 + Bayesian + WeightedAvg集成）
657样本 × 10特征，保留全部中间数据供画图使用
"""
import warnings
...
def main():
    ...
    print(f'[DONE] AKH 实验完成！所有CSV/JSON文件保存至: {RESULTS_DIR}')
